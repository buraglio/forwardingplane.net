...
I highly recommend taking a view of the talks from some folks using SR on some pretty significant networks - it's worth your time if you're really interested in throwing down with segment routing.  But what did this tell <b>*me***? Lets look further into SR and see why it's become so attractive to large, geographically diverse networks. First, SR builds on an existing knowledgeable. Far more people exist in the market that already know MPLS. The understand labels, they understand overlays, and they have vast experience with virtual circuits. Service providers are very likely MPLS based if they operate at any scale and offer typical ISP services. MPLS is well traveled, and even though there may be reasons that's not perfect, it's the devil we know. Other SDN technologies are either fairly green (l[et me tell you about running a production openflow experience](http://blog.ipspace.net/2015/12/running-open-daylight-in-production.html#more)) or are primarily focused on the data center, which as I will adamantly insist is a very different beast.
