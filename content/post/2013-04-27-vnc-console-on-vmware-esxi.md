...
There are, of course, a few caveats.  Knowing how to [properly edit the VMX file ](http://kb.vmware.com/selfservice/microsites/search.do?language=en_US&cmd=displayKC&externalId=1714)is important.  Knowing that VNC is insecure is also very important. In my lab, this is all behind my security perimeter and it's fairly safe to open it up.
